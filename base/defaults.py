...
DEFAULT_SECNET_IRC_SIZE_RANGE = [1,15] 
...
DEFAULT_SECNET_TOTALNODE_RATIO_RANGE = [1.0,5.0]
DEFAULT_SECNET_RNDSTRUCT = random 
DEFAULT_SECNET_ENTRY_SIZE_RATIO_RANGE = [0.1,1.0] 
...
DEFAULT_HYPSTRUCT_PARTIALLY_NAIVE_BOUND_LENGTH = 1.0 
DEFAULT_CRACKER_CRACKLING_SIZE_RATIO = [0.1,1.0] # w.r.t. number of nodes in SecNet 
DEFAULT_TDIR_RADIUS = 10 
